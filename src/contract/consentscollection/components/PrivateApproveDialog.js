...
const PrivateApproveDialog = ({ 
    ...
    const handleApprove = async () => {
        ...
        try {
            ...
            await onApprove(consent.privatePlotOwnerConsentId, updateDto);
            
            if (selectedFile) {
                await onUploadFile(consent.privatePlotOwnerConsentId, selectedFile);
            }
...
export default PrivateApproveDialog; 